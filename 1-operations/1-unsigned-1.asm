;//petit programme qui demande la saisie d'un nombre, effectue l'opération d'addition et affiche le résultat
;// resultat entre 0 à 9
...
;2//
; Lors de la compilation, lorsque le résultat est ge (greater or equal) à 10, le caractère ne s'affiche pas.
; Pourquoi ?
; Parce que la conversion ne correspond pas à la valeur souhaité
;add al, '0' suppose que la valeur est entre 0 et 9, sinon on doit boucler l'affichage